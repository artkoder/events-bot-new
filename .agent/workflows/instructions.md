...
7. **Исследование сайтов** — для исследования структуры веб-страниц всегда используй Playwright (создавай debug-скрипты), а НЕ browser subagent
8. **E2E Тесты** — при реализации новой feature (функционала) ОБЯЗАТЕЛЬНО создавай интеграционные (E2E) тесты, проверяющие полный цикл работы от входа до результата (БД/API).
