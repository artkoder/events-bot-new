...
def selection_prompt() -> str:
    return (
        ...
        " Ответ строго JSON."
        " intro_text — ОЧЕНЬ КОРОТКИЙ ЗАГОЛОВОК ДЛЯ ОБЛОЖКИ (2–4 слова, КАПСОМ, ≤32 символов с пробелами, без эмодзи и без знаков препинания). Это название рубрики/темы, а не предложение. НЕ пиши даты. Не начинай с “Мы выбрали/Представляем”."
    )
