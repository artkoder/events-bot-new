...
async def build_short_vk_text(
    ...
    *,
    ...
    prompt = (
        ...
        "Сразу начинай с главной идеи — не повторяй название события и не добавляй в начале блок про дату, время, место или билеты. "
    ...
    try:
        raw = await ask_4o(
            ...
            system_prompt=(
                ...
                "Сразу начинай с сути, не повторяй название события и не добавляй в начале блок про дату, время, место или билеты. "
