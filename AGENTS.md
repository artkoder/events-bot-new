...
1. Прочитай `CODEX.md` (инженерные правила и definition of done).
2. Открой `docs/README.md` (человеческий индекс).
3. Для “быстрого роутинга” используй `docs/routes.yml` (машиночитаемая карта).
