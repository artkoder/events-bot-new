 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "TELEGRAM_AUTH_BUNDLE_S22 = os.environ.get('TELEGRAM_AUTH_BUNDLE_S22') or ''\n",
    "TG_SESSION = ''\n",
    "device_config = {\n",
    ...
    "    'system_lang_code': 'ru',\n",
    "}\n",
    "if TELEGRAM_AUTH_BUNDLE_S22:\n",
    "    import base64\n",
    "    raw = base64.urlsafe_b64decode(TELEGRAM_AUTH_BUNDLE_S22.encode('ascii')).decode('utf-8')\n",
    "    bundle = json.loads(raw)\n",
    "    TG_SESSION = bundle.get('session', '')\n",
    "    device_config = {\n",
    "        'device_model': bundle.get('device_model') or 'Samsung S22 Ultra',\n",
    "        'system_version': bundle.get('system_version') or '13.0',\n",
    "        'app_version': bundle.get('app_version') or '9.6.6',\n",
    "        'lang_code': bundle.get('lang_code') or 'ru',\n",
    "        'system_lang_code': bundle.get('system_lang_code') or 'ru',\n",
    "    }\n",
    "else:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "    # Spoofing Params (from bundle or defaults)\n",
