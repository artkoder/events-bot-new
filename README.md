...
- Список алиасов добавляется к системному промпту 4o в виде JSON блока `festival_alias_pairs`, чтобы парсер сопоставлял дубли при
  создании новых событий и не плодил новые фестивали.
