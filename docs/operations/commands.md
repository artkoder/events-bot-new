...
| `/daily` | - | Manage daily announcement channels and VK posting times; send test posts. Daily event lines de-duplicate repeated venue/address/city fragments when `location_name` already contains them. |
