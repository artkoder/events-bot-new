...
| `/v` | - | Суперадмин: меню видео-анонсов с кнопками профилей (🎬 …), выбором тестового и основного канала из списка доступных админ-каналов, запуском новой сессии, перезапуском последней неуспешной и списком последних сессий со статусами/ссылками. Пока идёт рендеринг Kaggle, UI блокируется. Тестовое видео уходит в выбранный тестовый или операторский чат, основное — в выбранный основной канал (если указан). |
