...
| `/v` | - | Суперадмин: меню видео-анонсов с кнопками профилей (🎬 …), запуском новой сессии, перезапуском последней неуспешной и списком последних сессий со статусами/ссылками. Пока идёт рендеринг Kaggle, UI блокируется. Тестовое видео уходит в `VIDEO_ANNOUNCE_TEST_CHAT_ID` или операторский чат, основное — в `VIDEO_ANNOUNCE_MAIN_CHAT_ID`. |
