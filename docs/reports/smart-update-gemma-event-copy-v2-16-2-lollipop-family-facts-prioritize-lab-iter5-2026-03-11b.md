...
- lead support: `В программе презентации запланированы выступления артистов, шоу дрессированных собак и чтение стихов.`
