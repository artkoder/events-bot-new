...
- events: `12`
- avg_section_count: `2.417`
- events_with_program_section: `3`
...
- title_strategy: `keep`
- sections: `lead:narrative(FL01,EC01) -> body:narrative [О проекте «Собакусъел»](EC02,EC03,SC03,FL03,FL04,FL05,SC01,SC02) -> program:list [В программе](PL01) -> body:narrative(FL02)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,EC03) -> body:narrative [О художницах](EC02,SC01,SC02,SC03,SC04)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,PR01) -> body:narrative [Об исполнителе](SC01) -> program:list [В программе](PL01) list=4 partial`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,PR01) -> body:narrative [О вечеринке](SC05,SC02,SC01,SC03,SC04) -> program:list [Репертуар](PL01,PL02) list=10`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC02,EC03) -> body:narrative [О чем спектакль](EC01,EC04,PR01,SC01)`
...
- title_strategy: `keep`
- sections: `lead:narrative(SC03,PR01) -> body:narrative [О фильме](PR02,SC01,SC02,SC04)`
...
- title_strategy: `keep`
- sections: `lead:narrative(PL01) list=5 -> body:narrative [О вечере](SC02,SC03,SC04,SC01)`
- infoblock_labels: `Дата, Время, Локация, Цена`
- literal_items: `5`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,EC02) -> body:narrative [О коллекции](EC03,EC04,SC05,SC02)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,PR01) -> body:narrative [О мастер-классе](EC03,EC02,EC04,PR02,SC01,SC02,SC03)`
