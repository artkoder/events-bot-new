...
- title_strategy: `keep`
- sections: `lead:narrative(EC02,FL02) -> body:narrative [О проекте](EC01,EC03,FL01,FL03,FL04,FL05,SC03,SC01,SC02) -> program:list [Программа](PL01)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01,PR01) -> body:narrative [Что вас ждет](SC05,SC02,SC01,SC03,SC04) -> program:list [Репертуар](PL01,PL02) list=10`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC02,EC03) -> body:narrative(EC01,EC04,PR01,SC01)`
...
- title_strategy: `keep`
- sections: `lead:narrative(PL01) list=5 -> body:narrative(SC02,SC03,SC04,SC01)`
- infoblock_labels: `Дата, Время, Локация, Цена`
- literal_items: `5`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC02) -> body:narrative(EC01,SC04,SC01,SC02,SC03)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC01) -> body:narrative(EC02,EC03,EC04,SC05,SC02)`
...
- title_strategy: `keep`
- sections: `lead:narrative(EC03,PR02) -> body:narrative [О мастер-классе](EC01,EC02,EC04,PR01,SC03,SC02,SC01)`
