...
- title_strategy: `keep`
- layout: `lead:narrative(FL01,EC01) -> body:narrative [О проекте «Собакусъел»](EC02,EC03,SC03,FL03,FL04,FL05,SC01,SC02) -> program:list [В программе](PL01) -> body:narrative(FL02) -> infoblock:structured(LG01,LG02,LG03)`
...
- has_long_program: `False`
- title_strategy: `keep`
- layout: `lead:narrative(SC03,PR01) -> body:narrative [О фильме](PR02,SC01,SC02,SC04) -> infoblock:structured(LG01,LG02)`
...
- has_long_program: `False`
- title_strategy: `keep`
- layout: `lead:narrative(EC01,PR01) -> body:narrative [О мастер-классе](EC03,EC02,EC04,PR02,SC01,SC02,SC03) -> infoblock:structured(LG01,LG02,LG03,LG04,LG05)`
