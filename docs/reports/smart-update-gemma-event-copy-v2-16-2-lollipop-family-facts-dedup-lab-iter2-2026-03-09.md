...
- family: `facts.dedup`
- iteration: `iter2`
- design shift: `baseline_diff.v2 -> cross_enrich.v1 -> deterministic audit`
...
- avg_unique_enrichment_final: `5.083`
...
- reframe count: `1`
- cross duplicates: `0`
- unique enrichment final: `5`
- auto reclassified missing match: `1`
- flags: `auto_reclassified_missing_match`
...
- reframe count: `0`
- cross duplicates: `0`
- unique enrichment final: `8`
- auto reclassified missing match: `5`
- flags: `reframe_zero, auto_reclassified_missing_match`
...
- auto reclassified missing match: `2`
- flags: `auto_reclassified_missing_match`
...
- Этот round сохраняет ту же `baseline_diff -> cross_enrich -> audit` architecture, но ужесточает `baseline_match`, uncertainty ladder и anti-quota rules.
- `facts.dedup` по-прежнему оценивается как factual accounting / quality uplift layer, а не как narrative layer.
- Ключевой вопрос этого iter2: оживился ли `REFRAME`, исчезли ли `missing_baseline_match`, и появился ли у `cross_enrich` реальный материал.
