...
- family: `facts.merge`
- iteration: `iter2`
- design shift: `dedup outputs -> merge records -> bucket.v2 -> resolve.v2 -> emit.v1 -> deterministic audit.v2`
...
- avg_resolved_cluster_count: `11.25`
- avg_emitted_cluster_count: `11.25`
- avg_total_bucket_items: `11.25`
- events_with_flags: `4`
- events_with_duplicate_suspects: `4`
...
- baseline facts: `18`
- merge records: `16`
- resolved clusters: `16`
- emitted clusters: `16`
- bucket counts: `{'event_core': 4, 'program_list': 1, 'people_and_roles': 0, 'forward_looking': 5, 'logistics_infoblock': 3, 'support_context': 3, 'uncertain': 0}`
...
- resolved clusters: `9`
- emitted clusters: `9`
- bucket counts: `{'event_core': 1, 'program_list': 0, 'people_and_roles': 1, 'forward_looking': 0, 'logistics_infoblock': 4, 'support_context': 3, 'uncertain': 0}`
...
- emitted clusters: `14`
- bucket counts: `{'event_core': 2, 'program_list': 2, 'people_and_roles': 1, 'forward_looking': 0, 'logistics_infoblock': 5, 'support_context': 4, 'uncertain': 0}`
- flags: `merge_duplicate_suspect`
- duplicate_suspects: `1`
...
- `iter2` ретюнит только `bucket` и `resolve`; `facts.extract` и `facts.dedup` заново не прогоняются.
...
- Ключевой вопрос iter2: достаточно ли prompt-level tighten + duplicate-suspect audit, чтобы убрать generic-vs-specific duplication и semantic bucket bleed до `facts.prioritize`.
