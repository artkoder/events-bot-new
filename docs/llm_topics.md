...
Тему `KRAEVEDENIE_KALININGRAD_OBLAST` ставь для событий о локальной истории, урбанистике и краеведении Калининградской области — ориентируйся на упоминания региона, городов области или региональных сообществ.
    ...
    "topics": {
      ...
      "items": {
        ...
        "enum": [
          ...
          "THEATRE_MODERN", "LECTURES", "KRAEVEDENIE_KALININGRAD_OBLAST",
          "MASTERCLASS", "PSYCHOLOGY", "SCIENCE_POP", "HANDMADE",
          "FASHION", "NETWORKING", "ACTIVE", "PERSONALITIES",
          "HISTORICAL_IMMERSION", "KIDS_SCHOOL", "FAMILY"
        ]
      },
      "maxItems": 3,
      "uniqueItems": true
...
Отдельная тема `KRAEVEDENIE_KALININGRAD_OBLAST` ставится автоматически, когда в карточке встречаются признаки Калининградской области (город, адрес, хэштеги или упоминания локальной истории региона). События из других регионов по урбанистике и истории не получают эту тему автоматически, но её можно задать вручную.
