...
Сигнал (арт-пространство), Леонова 22, Калининград
...
Понарт, Судостроительная 6/2, Калининград
...
Мой бизнес, Уральская 18 (4 этаж), Калининград

Edit this file to keep location names consistent when parsing events.

Дополнительные флаги поведения для отдельных площадок (например, разрешить несколько событий в одно время) описаны в `docs/reference/location-flags.md`.
...
Дом офицеров Балтийского флота, Кирова 7, Калининград

YALTA, Ялтинская 66, Калининград

Royal Park, Невского 10, Калининград

МСЗ Созвездие, Гагарина 99, Калининград

ГрандМонополь, Володарского 32, Зеленоградск

Железный Занавес, Судостроительная 6, Калининград

HUMAN concept, Захарова 1, Калининград

Онегин (ресторан), Мира 4, Калининград

Бастион (арт-клуб), Дзержинского 31В, Калининград

Замок Тапиау, Центральная площадь 1, Гвардейск

Концертный зал КСО, Бакинская 13, Калининград

Океан (караоке-клуб), Театральная 35, Калининград

B SIDE (бар), Калинина 4, Калининград
