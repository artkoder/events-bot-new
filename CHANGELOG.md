...
- **Guide Excursions Monitoring / Digest Links**: guide digest cards now render as HTML, with the excursion title linking to the source post, the channel name linking to the source channel, and booking links rendered as clickable anchors instead of raw pasted URLs.
