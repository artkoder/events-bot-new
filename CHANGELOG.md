...
## v0.3.15 - Dump and docs

- `/dumpdb` now lists the VK group and advises using `/vkgroup` when restoring.
- README explains how to register daily posts via `/regdailychannels` and `/daily`.
