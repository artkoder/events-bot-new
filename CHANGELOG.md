...
## [x.y.z] - 2025-09-20
### Added
- Ввели ручной блок «🌍 Туристам» в Telegram и VK с кнопками «Интересно туристам»/«Не интересно туристам», меню причин и поддержкой комментариев, плюс экспорт `/tourist_export` в `.jsonl`.

### Changed
- Обновили справочник факторов: `🎯 Нацелен на туристов`, `🧭 Уникально для региона`, `🎪 Крупный фестиваль или событие`, `🌊 Природа или знаковое место`, `📸 Фотогенично, понравится блогерам`, `🍲 Местный колорит и ремёсла`, `🚆 Простая логистика`, а также документацию про TTL (15 минут для причин, 10 минут для комментария).
- README и профильные документы для туристической метки переписаны под новый сценарий и исследования GPT-5 Deep Research.
