...
### Changed
- Обновили справочник факторов:<br>`🎯 Нацелен на туристов`,<br>`🧭 Уникально для региона`,<br>`🎪 Фестиваль / масштаб`,<br>`🌊 Природа / море / лендмарк / замок`,<br>`📸 Фотогенично / есть что постить`,<br>`🍲 Местный колорит / кухня / крафт`,<br>`🚆 Просто добраться`, а также документацию про TTL (15 минут для причин, 10 минут для комментария).
