...
## [x.y.z] - 2025-09-20
### Added
- Обновили `docs/tourist-label/user-story.md`, зафиксировав точную user story и критерии приёмки для кнопок туристической метки, TTL сессий и выгрузки `/tourist_export`.

### Changed
- Переписали `docs/tourist-label/research.md`, уточнив цель GPT-5 Deep Research, формат JSONL-выгрузки, рекомендованный промпт и практику выгрузок.
- Обновили раздел README о туристической метке: перечислили кнопки, поведение TTL и ссылки на пользовательскую историю и исследование.

### Security
- Подчеркнули в документации, что ручные действия и `/tourist_export` доступны только неблокированным модераторам и администраторам.
