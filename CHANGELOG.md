...
- Перевели справочник сезонных праздников на нормализованный формат дат `MM-DD[..MM-DD]`, добавили столбец `tolerance_days` и обновили парсер импорта под новый формат.
