...
## [x.y.z] - 2025-09-20
### Added
- Ввели ручной блок «🌍 Туристам» в Telegram и VK
- с кнопками «Интересно туристам»/«Не интересно туристам»,
- меню причин и поддержкой комментариев,
- плюс экспорт `/tourist_export` в `.jsonl`.

### Changed
- Обновили справочник факторов:<br>`🎯 Нацелен на туристов`,<br>`🧭 Уникально для региона`,<br>`🎪 Крупный фестиваль или событие`,<br>`🌊 Природа или знаковое место`,<br>`📸 Фотогенично, понравится блогерам`,<br>`🍲 Местный колорит и ремёсла`,<br>`🚆 Простая логистика`, а также документацию про TTL (15 минут для причин, 10 минут для комментария).
