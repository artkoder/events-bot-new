...
## [x.y.z] - 2025-09-20
### Added
- Заменить `docs/tourist-label/user-story.md` текстом user story и критериев приёмки из постановки (включая точные кнопки, TTL, экспорт).

### Changed
- Обновить `docs/tourist-label/research.md`, чтобы отражать цель корпуса, описание выгрузки `/tourist_export`, готовый промпт и практику запуска исследования согласно ТЗ.
- В `README.md` переписать раздел «Туристическая метка (ручной режим)» с правильными названиями кнопок, TTL и ссылками на новые документы.

### Security
- Исправить запись `## [x.y.z] - 2025-09-20` в `CHANGELOG.md`, вставив списки Added/Changed/Security из задания без отклонений.
